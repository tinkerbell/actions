...
# Build stream
FROM golang:1.15-alpine as archive2disk
RUN apk add --no-cache git ca-certificates gcc musl-dev 
COPY . /go/src/github.com/tinkerbell/hub/actions/archive2disk/v1
WORKDIR /go/src/github.com/tinkerbell/hub/actions/archive2disk/v1
ENV GO111MODULE=on
...
COPY --from=archive2disk /go/src/github.com/tinkerbell/hub/actions/archive2disk/v1/archive2disk .
